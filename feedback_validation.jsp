...
<%
	...
	String date=getDate();
        ...
        con=(Connection)application.getAttribute("connection");
          ...
          ps= con.prepareStatement("insert into user_feedback values (?,?,?,?,?)");
            ps.setString(1,name);
            ...
            ps.setString(5,email);
             ...
             if (insertResult!=0)
            {
		out.println("<b><h4>Thanks For Feedback</h4></b><br><br>");
                 out.println("Thanks For Submitting Your valuable Feedback.");
            }          
        %>
</body>
</html>