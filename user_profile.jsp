...
<%
        ...
        PreparedStatement ps=con.prepareStatement("select * from register1 where email=?",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
...
<div id="wrapper"> 
  ...
  <div id="page_content"> 
    ...
    <div class="clear">
        ...
        <div style="margin:1px 200px 50px 500px; height: 470px; width:350px; border:2px solid white; background:grey;padding-top:0px">
