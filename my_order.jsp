...
<table width="auto" border="1" cellspacing="0">
  <tr>
    ...
    <td width="148" align="center"><strong>Seller</strong></td>
...
<% 
       PreparedStatement ps;
        ...
        conn=(Connection)application.getAttribute("connection");
		 ...
		 String sql = "SELECT * from payment where user_email=?"; 
...
%>
  ...
  <tr>
    ...
    <td align="center"><a href="trackorder.jsp?consignment=<%=rs.getString(10)%>"><img src="images/trackorder.png" width="100" height="70"/></a></td>
  </tr>
