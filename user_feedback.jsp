...
<p>
<form action="feedback_validation.jsp" style="display:inline;width:50%;margin:0 0 0 30%">
<table width="450" height="142" border="0" style="display:inline">
<tr><td><b><h4>Feedback Form</h4></b></td></tr>
<tr><td colspan=2>Write Us a feedback. We'd be glad to get the feedback.</td></tr>
<tr><td colspan=2>Please Enter Your :</td></tr>
  <tr>
  ...
  <tr>
    <td height="60" align="right">Your Feedback:</td>
    <td><textarea name="feedback" cols=40 rows=6 required></textarea></td>
  </tr>
<tr><td colspan=2 style="text-align:center"><input type="submit" name="submit" value="OK" /></td></tr>
</table>
