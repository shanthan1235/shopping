...
<% if(session.getAttribute("uname")==null) {
   ...
   <hr />
   <strong><em>Register Seller Account Here</em></strong>
   <form action="seller_reg.jsp"><table><b>
		...
		<option>Year</option><option>1970</option><option>1977</option><option>1988</option><option>1990</option>
            ...
            <tr><td>Bussiness Location : </td><td><input type="text" name="location" required></td></tr>
                <br>
                </b></table><br />
     <input type="submit" value="Register" />
            ...
            <br><hr>
              ...
              Register As Normal User!! <a href="register.jsp">Click Here</a>
                <hr>         
    </center>
</body>
</html>