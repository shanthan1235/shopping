...
function validation()
{
if(!((document.form1.optPaymentType[3].checked)||(document.form1.optPaymentType[4].checked)))
{
...
<br>
<form name="form1" action="order_submit.jsp" method="post" >
<table align=center border=0 width=700>
<tbody> 
...
<input name=optPaymentType       onClick="return checkpayment(this)" type="hidden"  value=draft>
<input name=optPaymentType onClick="return checkpayment(this)" type="hidden" value=cheque>
<input name=optPaymentType onClick="return checkpayment(this)" type="hidden" value=payorder>
